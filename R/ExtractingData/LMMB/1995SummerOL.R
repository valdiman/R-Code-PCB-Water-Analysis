...
LMMB_data <- read_csv("Data/LMMB/OpenLake/1995SummerOL.csv")
...
# Remove PCB. It doesn't sum correctly
transposed_data <- transposed_data[, !colnames(transposed_data) %in% c("PCB")]

# Create a new column named "tPCB" that sums columns 5 to 109
...
# Export results
write.csv(transposed_data, file = "Data/LMMB/OpenLake/1995SuOL.csv")
